...
export const menuItems: Menu[] = [
  ...
  {
    route: 'transaction', display_name: 'Transações', icon_name: 'payments', children: [
      { route: 'transaction/extract', icon_name: 'receipt_long', display_name: 'Extrato', children: [], open: false },
      { route: 'transaction/mov', icon_name: 'receipt_long', display_name: 'Movimentação da Conta', children: [], open: false }
    ], open: false
  },
